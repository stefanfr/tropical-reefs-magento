...
class OrderItems
{
    ...
    public function __construct(
        ...
        protected OptionsProcessor             $optionsProcessor
    )
    {
    }
    ...
    private function fetch()
    {
        ...
        foreach ($orderItems as $orderItem) {
            ...
            $this->orderItemList[$orderItem->getItemId()] = [
                ...
                'small_image' => $associatedProduct->getSmallImage(),
                'model' => $orderItem,
                ...
                'product_sale_row_total_incl_tax' => [
                    'value' => $orderItem->getRowTotalInclTax(),
                    'currency' => $associatedOrder->getOrderCurrencyCode(),
                ],
