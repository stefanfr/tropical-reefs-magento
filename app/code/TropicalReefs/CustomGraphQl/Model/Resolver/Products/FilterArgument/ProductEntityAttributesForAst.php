...
namespace TropicalReefs\CustomGraphQl\Model\Resolver\Products\FilterArgument;
 ...
 */
class ProductEntityAttributesForAst extends \Magento\CatalogGraphQl\Model\Resolver\Products\FilterArgument\ProductEntityAttributesForAst
{
     ...
     * @var array
     */
    private $additionalAttributes = ['min_price', 'max_price', 'entity_id'];

    public function __construct(ConfigInterface $config, array $additionalAttributes = [])
    {
    ...
    public function getEntityAttributes() : array
    {
        ...
        if (!$productTypeSchema instanceof Type) {
            throw new \LogicException((string)__("%1 type not defined in schema.", self::PRODUCT_BASE_TYPE));
        }
